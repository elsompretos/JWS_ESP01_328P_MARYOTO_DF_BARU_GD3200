...
switch (mode) {
    case 0: 
      ...
      if(b_tpl_nama==1){TPL_HH_TGL(3);}else{mode=10;}
    break;
    case 1: 
    ...
    case 7: 
      ...
      if(b_tpl_stlh_iqomah==1){TPL_HH_TGL(4);}else{mode=1;}
    break;
    case 8: 
      evt_0 = 1; evt_1 = 0; evt_2 = 1; evt_3 = 1; evt_4 = 1; evt_5 = 1; evt_6 = 1;
      TPL_HH();
    ...
    case 10: 
      ...
      if(b_tpl_info1==1){TPL_HH_TGL(6);}else{mode=11;}
    break;
    case 11: 
      evt_0 = 1; evt_1 = 1; evt_2 = 0; evt_3 = 1; evt_4 = 1; evt_5 = 1; evt_6 = 1;
      EEPROM.get(777, b_tpl_info2);;
      if(b_tpl_info2==1){TPL_HH_TGL(7);}else{mode=3;}
    break;
...
*/
  ...
  if ( !evt_2 && (millis()-p_e_2_hjry) > 75) {
    ...
    else
    {
      ...
      else if(pilih == 6){mode=11;}  // INFO 1 >> INFO 2
      else if(pilih == 7){mode=3;}   // INFO 2 >> JAM BESAR
      bsh = 0;
      flag = 0;
...
void AMBIL_WAKTU_SHOLAT(){            // AMBIL WAKTU SHOLAT
  ...
  double b_lati, b_longi, b_timezone;
      ...
      for(int ws=0; ws < SholatCount; ws++){
        ...
        if(ws==0){ waktu_ims = wkt_sol_sat;}
        if(ws==1){ waktu_sbh = wkt_sol_sat;}
        if(ws==2){ waktu_tbt = wkt_sol_sat;}
        if(ws==3){ waktu_dhu = wkt_sol_sat;}
        if(ws==4){ waktu_dzr = wkt_sol_sat;}
        if(ws==5){ waktu_asr = wkt_sol_sat;}
        if(ws==6){ waktu_mgr = wkt_sol_sat;}
        if(ws==7){ waktu_isy = wkt_sol_sat;}
    ...
    if(Menit == 0 && Detik == 0 && wkt_msk_skrg == 0){
          if(flag_mp3 == 0){
            mp3.setVolume(b_volume); 
            mp3.wakeup(2); 
            if (Jam == 1 || Jam == 13)      { mp3.playMP3Folder(5); }
            else if (Jam == 2 || Jam == 14) { mp3.playMP3Folder(6); }
            else if (Jam == 3 || Jam == 15) { mp3.playMP3Folder(7); }
            else if (Jam == 4 || Jam == 16) { mp3.playMP3Folder(8); }
            else if (Jam == 5 || Jam == 17) { mp3.playMP3Folder(9); }
            else if (Jam == 6 || Jam == 18) { mp3.playMP3Folder(10); }
            else if (Jam == 7 || Jam == 19) { mp3.playMP3Folder(11); }
            else if (Jam == 8 || Jam == 20) { mp3.playMP3Folder(12); }
            else if (Jam == 9 || Jam == 21) { mp3.playMP3Folder(13); }
            else if (Jam == 10 || Jam == 22){ mp3.playMP3Folder(14); }
            else if (Jam == 11 || Jam == 23){ mp3.playMP3Folder(15); }
            else if (Jam == 12 || Jam == 0) { mp3.playMP3Folder(16); } 
            flag_mp3 = 1;
          }     
      }
