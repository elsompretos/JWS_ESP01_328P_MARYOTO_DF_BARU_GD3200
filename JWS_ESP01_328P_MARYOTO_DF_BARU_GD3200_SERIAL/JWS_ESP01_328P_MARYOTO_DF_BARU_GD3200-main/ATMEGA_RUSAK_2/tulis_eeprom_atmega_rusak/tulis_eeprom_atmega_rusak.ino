...
void setup() {
  ...
  EEPROM.put(787, latitude);
  double longitude = 106.70116;
  EEPROM.put(792, longitude);
  double tz = 7;
  EEPROM.put(802, tz);
  ...
  int adj_subuh = 2; EEPROM.put(807, adj_subuh);
  int adj_dzuhur = 2; EEPROM.put(809, adj_dzuhur);
  int adj_ashar = 2; EEPROM.put(811, adj_ashar);
  int adj_maghrib = 2; EEPROM.put(813, adj_maghrib);
  int adj_isya = 2; EEPROM.put(815, adj_isya);
  int adj_imsak = 0; EEPROM.put(817, adj_imsak);
  int adj_terbit = 0; EEPROM.put(819, adj_terbit);
  int adj_dhuha = 2; EEPROM.put(821, adj_dhuha);
  ...
  writeString(71, "Masjid Abidzar Akbar"); // NAMA MASJID
